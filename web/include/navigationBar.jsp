        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" style="color:white" href="#"><span class="glyphicon glyphicon-menu-hamburger"></span>MEN&Ugrave;</a>
                <ul class="dropdown-menu">
                    <li><a href="${pageContext.response.encodeURL("restricted/shoppingLists.jsp")}">Le mie liste</a></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/shoppingListForm.jsp")}">Nuova lista</a></li>
                    <li><hr></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/products.jsp")}">I miei prodotti</a></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/productsForm.jsp")}">Aggiungi prodotto</a></li>
                    <li><hr></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/shoppingListCategories.jsp")}">Categorie lista</a></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/shoppingListCategoryForm.jsp")}">Nuova categoria lista</a></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/productsCategories.jsp")}">Categorie prodotto</a></li>
                    <li><a href="${pageContext.response.encodeURL("restricted/productCategory.jsp")}">Nuova categoria prodotto</a></li>
                </ul>
            </li>
        </ul>
